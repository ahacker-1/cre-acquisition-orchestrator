...
- Started: 2026-05-19T20:23:13.922Z
- Completed: 2026-05-19T20:23:13.932Z
- Verdict: PASS
...
## Findings
- Validated 200 units and rent strata.

## Agent Analysis
Primary finding: Validated 200 units and rent strata.

### Unit Mix and Rent Roll Tie-Out
| Type | Units | Avg SF | In-Place Rent | Market Rent | Monthly Gap |
| --- | --- | --- | --- | --- | --- |
| 1BR/1BA | 80 | 725 | $1,225 | $1,350 | $10,000 |
| 2BR/1BA | 40 | 900 | $1,450 | $1,600 | $6,000 |
| 2BR/2BA | 60 | 1050 | $1,650 | $1,800 | $9,000 |
| 3BR/2BA | 20 | 1200 | $1,900 | $2,100 | $4,000 |
- Occupancy used by due diligence: 94.0%.
- Loss-to-lease from deal configuration: $84,000.
- Rent roll sample limitation: No Phase I ESA document; No PCA/inspection report; No title commitment; Rent roll is sample (36 of 200 units)
...
- E01: rent-roll-analyst checked the property identity against parkview-2026-001 and the Austin / Travis County fixture narrative.
- E02: rent-roll-analyst reconciled purchase price to $32,000,000 before using any cap-rate or leverage conclusions.
- E03: rent-roll-analyst reconciled current NOI to $1,688,500 and stabilized NOI to $2,400,000.
- E04: rent-roll-analyst treated concessions as contra-revenue, bad debt as a separate loss line, and RUBS as utility expense recovery.
- E05: rent-roll-analyst carried annual Texas reassessment cadence into tax-adjusted risk language where property tax matters.
- E06: rent-roll-analyst preserved debt service, exit cap, and renovation premium assumptions from the deterministic source checkpoint.
- E07: rent-roll-analyst left any legal, tax, and lender-specific terms as diligence items unless directly present in the fixture.
- E08: rent-roll-analyst used the 27-scenario grid for downside/base/upside framing rather than a single-point answer.
- E09: rent-roll-analyst tied workpaper recommendations to conditional thresholds and dealbreaker policy.
- E10: rent-roll-analyst confirmed no external credentials, private files, or unverifiable market facts are embedded in this sample workpaper.
...
- rent-roll-analyst output is ready for Due Diligence orchestration review.
...
- rent-roll-analyst tickmark 01: reviewed source tie-out, calculation flow, risk wording, and downstream handoff consistency.
- rent-roll-analyst tickmark 02: reviewed source tie-out, calculation flow, risk wording, and downstream handoff consistency.
- rent-roll-analyst tickmark 03: reviewed source tie-out, calculation flow, risk wording, and downstream handoff consistency.
- rent-roll-analyst tickmark 04: reviewed source tie-out, calculation flow, risk wording, and downstream handoff consistency.
- rent-roll-analyst tickmark 05: reviewed source tie-out, calculation flow, risk wording, and downstream handoff consistency.
- rent-roll-analyst tickmark 06: reviewed source tie-out, calculation flow, risk wording, and downstream handoff consistency.
- rent-roll-analyst tickmark 07: reviewed source tie-out, calculation flow, risk wording, and downstream handoff consistency.
- rent-roll-analyst tickmark 08: reviewed source tie-out, calculation flow, risk wording, and downstream handoff consistency.
- rent-roll-analyst tickmark 09: reviewed source tie-out, calculation flow, risk wording, and downstream handoff consistency.
- rent-roll-analyst tickmark 10: reviewed source tie-out, calculation flow, risk wording, and downstream handoff consistency.
- rent-roll-analyst tickmark 11: reviewed source tie-out, calculation flow, risk wording, and downstream handoff consistency.
- rent-roll-analyst tickmark 12: reviewed source tie-out, calculation flow, risk wording, and downstream handoff consistency.
- rent-roll-analyst tickmark 13: reviewed source tie-out, calculation flow, risk wording, and downstream handoff consistency.
- rent-roll-analyst tickmark 14: reviewed source tie-out, calculation flow, risk wording, and downstream handoff consistency.
- rent-roll-analyst tickmark 15: reviewed source tie-out, calculation flow, risk wording, and downstream handoff consistency.
- rent-roll-analyst tickmark 16: reviewed source tie-out, calculation flow, risk wording, and downstream handoff consistency.
- rent-roll-analyst tickmark 17: reviewed source tie-out, calculation flow, risk wording, and downstream handoff consistency.
- rent-roll-analyst tickmark 18: reviewed source tie-out, calculation flow, risk wording, and downstream handoff consistency.
- rent-roll-analyst tickmark 19: reviewed source tie-out, calculation flow, risk wording, and downstream handoff consistency.
- rent-roll-analyst tickmark 20: reviewed source tie-out, calculation flow, risk wording, and downstream handoff consistency.
- rent-roll-analyst tickmark 21: reviewed source tie-out, calculation flow, risk wording, and downstream handoff consistency.
- rent-roll-analyst tickmark 22: reviewed source tie-out, calculation flow, risk wording, and downstream handoff consistency.
- rent-roll-analyst tickmark 23: reviewed source tie-out, calculation flow, risk wording, and downstream handoff consistency.
- rent-roll-analyst tickmark 24: reviewed source tie-out, calculation flow, risk wording, and downstream handoff consistency.
- rent-roll-analyst tickmark 25: reviewed source tie-out, calculation flow, risk wording, and downstream handoff consistency.
- rent-roll-analyst tickmark 26: reviewed source tie-out, calculation flow, risk wording, and downstream handoff consistency.
- rent-roll-analyst tickmark 27: reviewed source tie-out, calculation flow, risk wording, and downstream handoff consistency.
- rent-roll-analyst tickmark 28: reviewed source tie-out, calculation flow, risk wording, and downstream handoff consistency.
- rent-roll-analyst tickmark 29: reviewed source tie-out, calculation flow, risk wording, and downstream handoff consistency.
- rent-roll-analyst tickmark 30: reviewed source tie-out, calculation flow, risk wording, and downstream handoff consistency.
